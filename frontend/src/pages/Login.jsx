      ...
      {showOtpModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full shadow-2xl border border-gray-200">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Security Verification Required</h3>
            <p className="text-sm text-gray-600 mb-4">
              We detected a login attempt from a new device. Please enter the 6-digit OTP sent to <strong>{otpEmail}</strong>.
            </p>
            {devOtp && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <Link to="/forgot-password" className="text-[11px] text-[#0074cc] hover:text-[#0a95ff]">
                Forgot password?
              </Link>
            </div>
            <input
